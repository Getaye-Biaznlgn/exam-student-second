...
export default function ExamPage({ params }: { params: { examId: string } }) {
  ...
  const calculateResults = () => {
    ...
    const passed = scorePercentage >= (exam.passing_marks / exam.total_marks) * 100
  ...
  if (examFinished) {
    ...
    return (
      <div className="flex flex-col h-full">
        <DashboardHeader title="Exam Results" description="Your performance summary" />
        <div className="flex-1 p-6">
          <div className="max-w-4xl mx-auto space-y-6">
            <Card className={results.passed ? "border-success/50" : "border-destructive/50"}>
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <div className="grid gap-4 md:grid-cols-4">
                  <div className="flex flex-col items-center gap-2 p-4 rounded-lg bg-primary/10 border border-primary/20">
                    ...
                    <p className="text-3xl font-bold">{results.scorePercentage}%</p>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between p-3 rounded-lg bg-accent/5">
                      ...
                      <span className="font-semibold">
                        {answers.size > 0 ? Math.round((results.correct / answers.size) * 100) : 0}%
                      </span>
                    </div>
                    <div className="flex justify-between p-3 rounded-lg bg-accent/5">
                      <span className="text-muted-foreground">Completion Rate</span>
                      <span className="font-semibold">{Math.round((answers.size / exam.questions.length) * 100)}%</span>
                    </div>
                    <div className="flex justify-between p-3 rounded-lg bg-accent/5">
        ...
        <AlertDialog open={showTimeUpDialog} onOpenChange={setShowTimeUpDialog}>
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              <AlertDialogAction onClick={() => setShowTimeUpDialog(false)}>View Results</AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
      </div>
  ...
  if (!examStarted) {
    return (
      <div className="flex flex-col h-full">
        <DashboardHeader title={exam.title} description="Exam instructions and details" />
        <div className="flex-1 p-6">
          <div className="max-w-4xl mx-auto space-y-6">
            <Card>
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside">
                    <li>The exam is timed. Once started, the timer cannot be paused.</li>
                    <li>You can navigate between questions and change your answers before submitting.</li>
                    <li>All questions must be answered to achieve the best score.</li>
                    <li>The exam will auto-submit when time runs out.</li>
                    <li>You need {Math.round((exam.passing_marks / exam.total_marks) * 100)}% to pass this exam.</li>
                    <li>No explanations will be shown during the exam - this simulates real exam conditions.</li>
                  </ul>
                </div>
        ...
        <div className="max-w-7xl mx-auto flex gap-6">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {exam.duration_minutes && <ExamTimer durationMinutes={exam.duration_minutes} onTimeUp={handleTimeUp} />}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="h-2 bg-secondary rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${((answers.size / exam.questions.length) * 100).toFixed(0)}%` }}
                      />
                    </div>
                  </div>
                </CardContent>
          ...
          <div className="w-80 shrink-0">
            <Card className="sticky top-6">
              <CardHeader>
                ...
                <CardDescription className="text-xs">Click to jump to any question</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          !isCurrent && isAnswered && "border-success/50 bg-success/10 text-success",
                          !isCurrent && !isAnswered && "border-border hover:border-primary/50",
                        )}
                      >
                        {index + 1}
                      </button>
      ...
      <AlertDialog open={showSubmitDialog} onOpenChange={setShowSubmitDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              You have answered {answers.size} out of {exam.questions.length} questions. Are you sure you want to
              submit? You won't be able to change your answers after submission.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
